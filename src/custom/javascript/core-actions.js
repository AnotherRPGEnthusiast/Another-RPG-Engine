/*	Actions used by the default characters included in the base engine.
		If the default characters are used, this file must be present or the game will fail to compile.
		If the default characters are deleted, this file can be safely deleted as well. */
